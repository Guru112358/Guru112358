...
#any integral can be be boken up into a summation with infinite terms as the step tends to zero according to the fundamental theorem of Integral calculus.
